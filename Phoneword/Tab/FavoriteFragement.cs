...
namespace Tab
{
	public class FavoriteFragement : Fragment
	{
		...
		public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			CustomList adapter = new CustomList( Activity, contact.FavoriteWeb, contact.FavoriteImageId);
			...
			list.ItemLongClick+= delegate(object sender, AdapterView.ItemLongClickEventArgs e) {
				...
				animator.AnimationEnd += delegate{
					...
					adapter=new CustomList( Activity, contact.FavoriteWeb, contact.FavoriteImageId);
					list.Adapter=adapter;
				};
				animator.Start();
